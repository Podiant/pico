(function (factory) {
  ...
  var ObjectTemplate = function ObjectTemplate(obj) {
    var _this = this;

    _classCallCheck(this, ObjectTemplate);
    ...
    this.render = function () {
      var template = "<div class=\"object ".concat(escapeHtml_1(obj.type), "-object\">\n                ").concat(_this.inner(), "\n            </div>");
      return template;
    };
  };
  ...
  var StageTemplate =
  /*#__PURE__*/
  function (_ObjectTemplate) {
    _inherits(StageTemplate, _ObjectTemplate);

    function StageTemplate(obj) {
      var _this2;

      _classCallCheck(this, StageTemplate);

      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(StageTemplate).call(this, obj));

      _this2.inner = function () {
        return "<span class=\"stage-name\" style=\"color: ".concat(escapeHtml_1(obj.attributes.colour), "\">\n                <i class=\"fa fa-circle\"></i>\n                ").concat(escapeHtml_1(obj.attributes.name), "\n            </span>");
      };
  ...
  /*#__PURE__*/
  function (_ObjectTemplate2) {
    _inherits(EvidenceTemplate, _ObjectTemplate2);

    function EvidenceTemplate(obj) {
      var _this3;

      _classCallCheck(this, EvidenceTemplate);

      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(EvidenceTemplate).call(this, obj));

      _this3.inner = function () {
        var template = '';

        if (obj.attributes.media) {
          template += "<a class=\"btn btn-default btn-sm bg-white\" href=\"".concat(obj.attributes.media, "\" download>\n                    <i class=\"fa fa-download\"></i>\n                    Download media\n                </a>");
        }

        if (obj.attributes.notes) {
          template += "<div class=\"notes\">\n                    ".concat(escapeHtml_1(obj.attributes.notes), "\n                </div>");
        }
  ...
  var TaskTemplate =
  /*#__PURE__*/
  function (_ObjectTemplate3) {
    _inherits(TaskTemplate, _ObjectTemplate3);

    function TaskTemplate(obj) {
      var _this4;

      _classCallCheck(this, TaskTemplate);

      _this4 = _possibleConstructorReturn(this, _getPrototypeOf(TaskTemplate).call(this, obj));

      _this4.inner = function () {
        return "".concat(escapeHtml_1(obj.attributes.name));
      };
  ...
  var ActivityTemplate = function ActivityTemplate(context) {
    _classCallCheck(this, ActivityTemplate);

    var title = context.title;
    var created = moment(context.created).fromNow();
    var classes = ['inner'];
    var creatorNameParts = [];

    if (context.creator.attributes.first_name) {
      creatorNameParts.push(context.creator.attributes.first_name.trim());
    }

    if (context.creator.attributes.last_name) {
      creatorNameParts.push(context.creator.attributes.last_name.trim());
    }

    var creatorName = creatorNameParts.join(' ').trim();
    var inner = '';
    ...
    this.render = function () {
      var template = "\n                <div class=\"".concat(classes.join(' '), "\">\n                    <span class=\"title\">").concat(escapeHtml_1(title), "</span>\n                    ").concat(inner, "\n                </div>\n                <small class=\"text-muted timesince\">\n                    ").concat(escapeHtml_1(created), ", by\n                    <a href=\"javascirpt:;\">").concat(escapeHtml_1(creatorName), "</a>\n                </small>\n            ");
      return template;
    };
  };
  ...
  function (_EventEmitter) {
    ...
    function Activity(settings) {
      ...
      _this5 = _possibleConstructorReturn(this, _getPrototypeOf(Activity).call(this));
      _this5.id = settings.id;

      _this5.attach = function (dom, animated) {
        var container = $$3('<div>').addClass('activity');

        var render = function render() {
          var template = new ActivityTemplate(settings);
          ...
          container.addClass("activity-".concat(settings.kind));
        };

        _this5.on('render', render);
      ...
      _this5.update = function (attrs) {
        var newSettings = $$3.extend({
          id: settings.id
        }, attrs);
        settings = newSettings;
  ...
  /*#__PURE__*/
  function (_EventEmitter3) {
    _inherits(ActivityStream, _EventEmitter3);

    function ActivityStream(dom) {
      var _this3;

      _classCallCheck(this, ActivityStream);
      ...
      var db = new Database(url);
      var actsByID = {};
      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(ActivityStream).call(this));
      db.on('created', function (type, data) {
        if (type === 'activity') {
          var obj = new Activity($$4.extend({
            id: data.id
          }, data.attributes));
        ...
        if (type === 'activity') {
          dom.html('');
          data.slice().reverse().forEach(function (datum) {
            var obj = new Activity($$4.extend({
              id: datum.id
            }, datum.attributes));
  ...
  function (_EventEmitter4) {
    _inherits(EvidenceModal, _EventEmitter4);
    ...
    function EvidenceModal(dom, settings) {
      ...
      _this4 = _possibleConstructorReturn(this, _getPrototypeOf(EvidenceModal).call(this));
      ...
      var hide = function hide() {
        ...
        if (!_this4.evidence) {
          ...
          _this4.emit('submitted', _this4.evidence);
        }
      };
      ...
      if (Array.isArray(settings.evidence_categories)) {
        settings.evidence_categories.forEach(function (cat) {
          var option = $$4('<option>').attr('value', cat.id).text(cat.name);
  ...
  function (_ViewBase) {
    ...
    _createClass(DeliverableDetailView, [{
      ...
      key: "ready",
      value: function ready() {
        $$4('.stage-timeline[data-id]').each(function () {
          var dom = $$4(this);
          var timeline = new StageTimeline(dom);
          dom.data('timeline', timeline);
        });
        $$4('.activity-timeline[data-id]').each(function () {
          var dom = $$4(this);
          var timeline = new ActivityStream(dom);
          dom.data('timeline', timeline);
        });
        $$4('.card.tasks[data-id]').each(function () {
          var dom = $$4(this);
          var list = new TaskList(dom);
          list.on('evidence.required', function (request) {
            var modal = new EvidenceModal($$4('#evidence-request'), {
